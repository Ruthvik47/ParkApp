...
public class TheathreActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    private FirebaseAuth firebasehome;
    private FirebaseUser user;
    private String DB_URL="Theatres";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TheatreListView =(ListView) findViewById(R.id.TheatreContentListView);
        firebaseClient=new FirebaseClient(this, TheatreListView, DB_URL);
        ...
        TheatreListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position==0) {
                    ...
                    i.putExtra("Categoryid", "-KnQ8JS6uUJ5ZuhG3DKA");
                    i.putExtra("Category", "Theatres");
                    startActivity(i);
                }
                if(position==1) {
                    Intent i = new Intent(getApplicationContext(), SelectionActivity.class);
                    i.putExtra("Categoryid", "-KnQ8MKnrumTtQnre7V2");
                    i.putExtra("Category", "Theatres");
                    startActivity(i);
                }
                if(position==2) {
                    Intent i = new Intent(getApplicationContext(), SelectionActivity.class);
                    i.putExtra("Categoryid","-KnQ8Q3z_kbJxfkYyRJe");
                    i.putExtra("Category", "Theatres");
                    startActivity(i);
                }
                if(position==3) {
                    Intent i = new Intent(getApplicationContext(), SelectionActivity.class);
                    i.putExtra("Categoryid","-KnQ8TNj82suXMxajs3K");
                    i.putExtra("Category", "Theatres");
                    startActivity(i);
                }
                if(position==4) {
                    Intent i = new Intent(getApplicationContext(), SelectionActivity.class);
                    i.putExtra("Categoryid", "-KnQ8VWx0aH_0vLUX6vV");
                    i.putExtra("Category", "Theatres");
                    startActivity(i);
                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.theathre, menu);
        return true;
    }
